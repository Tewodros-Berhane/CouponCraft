...
couponsRouter.delete(
  ...
  asyncHandler(async (req, res) => {
    ...
    await prisma.$transaction([
      prisma.redeemToken.deleteMany({ where: { couponId: coupon.id } }),
      prisma.share.deleteMany({ where: { couponId: coupon.id } }),
      prisma.analyticsEvent.deleteMany({ where: { couponId: coupon.id } }),
      prisma.redemption.deleteMany({ where: { couponId: coupon.id } }),
